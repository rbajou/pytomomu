#Taken here: https://zulko.wordpress.com/2012/09/29/animate-your-3d-plots-with-pythons-matplotlib/
...
def make_gif(files, output, delay=100, repeat=True, **kwargs):
    ...
    cmd = f"convert -delay {delay} -loop {loop} {' '.join(files)} {output}"
...
if __name__ == '__main__':
    ...
    rotanimate(ax, angles,'out/movie.gif', delay=50)
